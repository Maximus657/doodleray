...
export const translations = {
  ...
  settings: 'Settings',
    ...
    launchStartupDesc: 'Start DoodleRay when Windows boots',
    launchSilentAdmin: 'Silent Admin Startup (Bypass UAC)',
    launchSilentAdminDesc: 'Boot seamlessly with admin privileges (Windows Task)',
    runAdmin: 'Run as Administrator',
    runAdminDesc: 'Required for TUN mode',
    runAdminWarning: 'TUN interface needs admin privileges',
  ...
  settings: 'Настройки',
    ...
    system: 'Система',
    launchStartup: 'Запускать при старте',
    launchStartupDesc: 'Запускать DoodleRay при включении ПК',
    launchSilentAdmin: 'Скрытый Админ-Автозапуск',
    launchSilentAdminDesc: 'Запуск с макс. правами без UAC при старте Windows',
    runAdmin: 'Запускать от Администратора',
    runAdminDesc: 'Требуется для TUN-режима',
    runAdminWarning: 'Без прав админа TUN не работает',
  ...
  settings: '设置',
    ...
    system: '系统',
    launchStartup: '开机自启',
    launchStartupDesc: 'Windows启动时运行 DoodleRay',
    launchSilentAdmin: '静默管理员自启 (绕过UAC)',
    launchSilentAdminDesc: '在后台以最高权限无缝启动 (计划任务)',
    runAdmin: '以管理员身份运行',
    runAdminDesc: 'TUN 模式必须',
    runAdminWarning: 'TUN 接口需要管理员权限',
    socksPort: 'SOCKS5 端口',
    httpPort: 'HTTP 端口',
